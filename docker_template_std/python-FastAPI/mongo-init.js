const keyValueDb = process.env.ASSESSMENT_BACKEND_DB;
const keyValueUser = process.env.ASSESSMENT_BACKEND_USER;
const keyValuePass = process.env.ASSESSMENT_BACKEND_PASSWORD;
